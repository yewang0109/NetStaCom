function [sta_set,sta_un,sta_theory]=stability_comparison_competitive(c,num_set,aver_num_set,sigma,d,T)
...
for s=100:20:300
    ...
    stability_theory(kk)=-sigma*(sqrt(s*c1)*(1+(1-2*c1)*2/pi)/sqrt(1-c1*2/pi)+c1*sqrt(2/pi))+d;
    kk=kk+1;
end
sta_set=stability_1;
sta_un=stability_2;
